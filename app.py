...
def _safe_storage_class(prediction):
    ...
    if not value:
        ...
        raise RuntimeError(
            "The model returned an empty disease class."
        )
...
def save_diagnosis_to_supabase(
    ...
    """
    Upload the diagnosed image to Supabase Storage.
    ...
    try:
        ...
        disease_class = _safe_storage_class(
            prediction
        )
        ...
        # Example:
        #
        # Late_blight/2026/08/13/
        # 7b4e4f3e9f1f4c9e8a....jpg
        #
        ...
        # --------------------------------------------------------
        # CLEAN UP ORPHANED STORAGE IMAGE
        # --------------------------------------------------------
...
if not isinstance(
    ...
    st.error(
        "GAIA model configuration contains no classes."
    )
